...
folketal i midten er given ved:

$$
\begin{align}\label{eq:midfolk1}
\tilde t &= (t_1+t_2)/2
\tilde N^{\textt{metode 1}}[t_1,t_2]&=N(\tilde t)
\end{align}
$$
...
gennemsnit af de to tal: 

*** Bedst mulige metode 

Her skal man kende folketal i starten, i slutningen og ved mindst et
tidspunkt mere i perioden. For eksempel, hvis man har at beregne det
approksimative middelfolketal bruges f
