* HEADER                                                           :noexport:
#+TITLE: Modul 1: Holdundervisning
#+DATE: 
#+LANGUAGE:  en
...
* Løsningsforslag                            :ignore:solution:
...
Nej, fordi der mangler en angivelse af perioden ("hvornår"). Det ville være en kohorte, hvis man fx definerede alle personer, der flyttede til et byområde i perioden 2000-2010, og fulgte dem fremad i tid. 
</text:p>
#+END_EXPORT
...
kun 5 personer. Baseret på tallene fra grafen, besvar følgende
...
#+BEGIN_EXPORT odt
<text:p text:style-name="Loesningsforslag">
Perioden strækker sig fra 1. april 2013 til 13. maj 2013 og har en
varighed på 6 uger.

Folketallet den 1. april 2013 (N(1. april 2013)) er 3 personer, og
folketallet den 13. maj 2013 er 2 personer.

For at beregne det eksakte middelfolketal summerer vi risikotiderne
for de 5 personer (2+4+6+1+5), hvilket giver en samlet risikotid på 18
personuger. Middelfolketallet udregnes som 18/6 = 3 personer. Ved brug
af metode 1 er middelfolketallet også 3 personer. Det er ikke 4, fordi
den person, der døde præcis midt i perioden, ikke er i live den dag.

Ved brug af metode 2 er middelfolketallet (3+2)/2 = 2,5 personer.  

Antallet af dødsfald i perioden er D[1. april 2013, 13. maj 2013]
= 2. Mortalitetsraten for perioden beregnes dermed som 2/18 ≈ 0,11
dødsfald per personuge.
</text:p>
#+END_EXPORT
