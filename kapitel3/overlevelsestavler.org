...
#+CAPTION: Forklaring af kolonner i en årsagsspecifikke dødelighedstavle
#+ATTR_LATEX: :align l|l
| Kolonne    | Betydning                                                                                         |
|------------+---------------------------------------------------------------------------------------------------|
| =Alder=    | Aldersinterval                                                                                    |
...
| =qQ=       | Dødshyppighed: sandsynlighed for at dø i intervallet givet i live ved intervallets start          |
| =L=        | Samlet risikotid i intervallet                                                                    |
| =e=        | Middelrestlevetid (i første interval =  middellevetid)                                            |
