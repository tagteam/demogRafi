...
Menneskers død har forskellige årsager, som fortæller hvad der er sket lige
inden, for eksempel en trafikulykke, eller samenfatter et kortere eller
længere sygdomsforløb før døden indtræffer. I Danmark har man siden 1875
samlet data om dødsårsager, som nu er verdens største
...
døde i Danmark. Den demografiske analyse af dødsårsager er
formåls- og metodemæssigt relateret til de andre fag i dette semester
...
restlivstidsrisikoen (sandsynligheden for at en \(x\)-årig dør af en bestemt årsag).

** Gruppering af dødsårsager

Dødsårsager i dødsårsagsregisteret er opdelt i A og B-grupperinger, hvor B er en undergruppering af A
grupperingerne. Statistikbankens register =DODA1= har antal døde fordelt på
26 A-grupperinger:
...
største A-gruppering i 2022. Der er i alt 109 B-grupperinger, hvor hver
B-gruppering hører under en A-gruppering.  Kræft er den dødsårsag med flest
B-undergrupper. A-grupperingerne er mere overordnede, mens B-grupperingeringerne er mere
specifikke. For eksempel er der tre B-grupperinger som opdeler gruppen A-08
...
dødelighedstavle, dobbelt-dekrementfunktionen.

*** Den årsagsspecifikke restlivstidsrisiko 

Det samlede antal dødfald med årsag \(Q\) i tabelbefolkningen, hvor
tabelpersonen er ældre end \(x\)-år er (for 1-års intervaller), er givet som:
...
\intertext{Tilsvarende er risikoen for at dø med andre årsager inden alder \(x\):}
...
Vi beregner dødelighedstavlen for at dø med kræft blandt mænd i 2020 i
...
\(x+k-1\) angiver restlivstidsrisikoen for at dø med kræft for en tabelperson
med alder \(x\), og \(\operatorname{risiko_Q}\) angiver risiko for at
en tabelperson dør af kræft inden alder \(x+k\). Fra
dødelighedstavlen kan vi f.eks. aflæse, at sandsynligheden
for at en nyfødt dreng i 2020 dør på af kræft inden alder 74 er
10,1%, hvis de årsagsspecifikke mortalitetsrater for
mænd i fremtiden forbliver som de var i 2020. Vi ser også, at
