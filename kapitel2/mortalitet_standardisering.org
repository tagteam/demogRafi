...
følger (Kapitel 4). Dette skift er ofte drevet af økonomisk vækst,
forbedret sundhed og sociale forandringer, som påvirker beslutninger
om familiedannelse.  Som konsekvens af den demografiske transition
ændres befolkningssammensætningen.
...
informere om ændringer i dødeligheden over tid. Udvikling af
dødelighed i Danmark mellem 1974 og 2022 ses i Figur
ref:fig:k2-sum-mort.
...
behøver ikke at være lige store. Da alle personers aldre ændrer sig
hele tiden, skal man angive den dato, som folketal refererer til. For
eksempel kan vi tale om aldersfordelingen af kvinder i Danmark
...
to standardiserede mortalitetsrater er det /standardiserede rate
...
dansker i 2011. Dette bekræfter, at grunden til at den summariske
