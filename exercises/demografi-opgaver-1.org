...
'Demografi/Opgaver'. Hvis du vælger undermappen er det vigtigt at du
...
kompendium kapitel 1 afnsit 3). Hvis det fejler kan det være fordi du
ikke har adgang til internettet? Eller fordi du ikke endnu har
installeret alle R pakker som vi bruger i kurset?
...
- Danner alle personer som hedder Michael i Danmark en kohorte? Begrund
  dit svar.
...
- Nej, der mangler perioden hvornår. Begivenheden kan være at en
  person bliver kaldt Michael (hvad) og det er personer i Danmark
  (hvem). Det ville være en kohorte, hvis man fulgte alle personer med
  navnet Michael i perioden 2000-2010.
