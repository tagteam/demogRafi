...
1. Find register =DODA1= i browseren: https://www.statistikbanken.dk/.
   Hvorfor angiver man alderstrin 0-1 separeret fra alderstrin 1-4?
...
3. [@3] Hvorfor er det ikke helt fair at sammenligne mænd og kvinder
   med hensyn til de summariske rater af død på grund af psykiske
   lidelse?
4. [@4] Brug tal fra statistikbanken til at beregne
   aldersstandardiserede rater af død på grund af psykiske lidelser,
   via direkte standardisering, separat for kvinder og
   mænd. Standardiser begge rater med hensyn til aldersfordelingen af
   alle dansker i 2018. Rapporter resultaterne og diskuter forskellene
...
4. [@4] Først henter I de aldersspecifikke antal døde pga psykiske
   lidelser separat for hver køn fra statistikbankens DODA1. Bagefter
   henter I aldersfordeling af risikotid (via middelfolketal og
   metode 1) for alle dansker i 2018 fra FOLK1a:
...
1. Fordi det forventede antal år levet i intervallet af en, som dør i intervallet er meget lavt på grund af perinatal, neonatal, post-neonatal og spædbarnsdødelig. 
2. [@2] Risikotid i 2018 for kvinder og mænd var hhv., 2908 og 2882 tusind
   personår. De summariske mortalitetsrater for død på grund af
   psykiske lidelser er:
 - Kvinder: 2313/2908337 = 0,80 per 1000 personår
 - Mænd: 1555/2881620 =0,54 per 1000 personår
3. [@3] Fordi kvinder bliver ældre end mænd, og død på grund af en psykiske lidelse,
   forkommer hyppigt bland ældre mennesker. 
4. [@4] De aldersstandardiserede rater af død på grund af psykiske
...
1. [@1] Det giver mening, hvis man har beregnet dødelighedstavlen
   ...
   'person' fra tabelbefolkningen bliver 'udsæt' for alle
   dødshyppigheder på tværs af alle aldersintervaller.
2. [@2] Det kan man ikke se i figuren, da figuren kun viser det relative antal kræftdødsfald bland dem som døde. 
...
3. [@3] Fortolkning af hele tabellen er for en tabelbefolkning som
   ...
   70 årige tabelperson). Risiko for kræftdød op til 70-års alderen er 10.22% og
   sandsynligheden for at blive 70-år gamle er 70.68%.
...
2. [@2] Beregn andel kræftdødsfald bland døde og bagefter årsagsspecifikke dødelighedstavler for mænd 
   i 2010 og 2020 i Danmark.
3. [@3] Rapporter livstidsrisiko for død af kræft i 2010 og i 2020 (danske mænd).
