...
5. Fordi mortalitetsraterne kommer til at ændre sig!
   # Den rigtige fortolkning er: 21,2 år er den forventede restlevetid for en 11-årig
   # dreng, hvis mortalitetsraterne fra 2008/2009 holder sig konstant i al fremtid. /Note:/ Det her giver ikke mening;
   # hvad har det med en 11-årig /dreng/ at gøre? 
...
#+BEGIN_SRC R  :results output raw drawer :exports (exercise-with-solutions) :session *R* :cache yes :eval (never-plain-export)
<<<<<<< HEAD
x1 <- mutate(x1,a = c(0.1,rep(0.5,99)),k = rep(1,100)) ## burde det ikke være 0.5 i stedet for 1?
=======
...
2. [@2] Rapporter mortalitetsraten for 0-årige og 5-årige drenge. Mortalitetsraten for 0-årige drenge var 3,1 døde/1000 personår og for 5-årige drenge 0,03 døde/1000 personår i 2009.
4. [@4] Rapporterer tabellens værdi i kolonne =e= for alderstrinnene 0 og 84 år:
        ...
        at de aldersspecifikke mortalitetsrater fra 2009 ikke ændrer sig i fremtiden.
        Den forventede middelrestlevetid af 84-årige mænd i 2009 i Danmark er 5,9 år under antagelsen, 
        at de aldersspecifikke mortalitetsrater fra 2009 ikke ændrer sig i fremtiden.
